    ...
    try:
        ...
        try:
            ...
            if table.time_partitioning:
                if table.time_partitioning.type_ == bigquery.TimePartitioningType.DAY:
                    ...
                    print(f"      python scripts/bigquery/pluviometricos/exportar_pluviometricos_nimbus_bigquery.py")
        ...
        if not ultimas_por_estacao:
            ...
            if ultima_sincronizacao == datetime(1997, 1, 1, tzinfo=timezone.utc):
                ...
                print("   Execute PRIMEIRO: python scripts/bigquery/pluviometricos/exportar_pluviometricos_nimbus_bigquery.py")
...
def main():
    ...
    try:
        if '--once' in sys.argv:
            ...
            print("   python scripts/bigquery/pluviometricos/sincronizar_pluviometricos_nimbus_bigquery.py --once")
